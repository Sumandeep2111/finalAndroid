...
public class AddFileActivity extends AppCompatActivity implements OnMapReadyCallback {
...
//    double latitude, longitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addactvityfile);
        initMap();
        getUserLocation();
        setHomeMarker();
...
//        LatLng userLatlng = new LatLng(location.getLatitude(),location.getLongitude());
    ...
    private void addressOfFavouritePlaces(LatLng latLng){
        ...
        try{
            ...
            if(!addresses.isEmpty()){
                ...
                if (onMarkerClick && mDatabase.addFvrtPlaces(addresses.get(0).getLocality(),addDate,addresses.get(0).getAddressLine(0),latLng.latitude,latLng.longitude)){

                    onMarkerClick = false;
                    Toast.makeText(AddFileActivity.this, "places:"+addresses.get(0).getAddressLine(0), Toast.LENGTH_SHORT).show();
                }else {

                    Toast.makeText(AddFileActivity.this, "places NOT FOUND:", Toast.LENGTH_SHORT).show();
    ...
    public void btnClick(View view) {
        ...
        Intent intent = new Intent(this,listfvrtplacesActivity.class);
