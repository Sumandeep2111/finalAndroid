    ...
    private void addressOfPlaces(LatLng latLng){
        ...
        try{
            ...
            if(!addresses.isEmpty()){
                ...
                if (mDatabase.addFvrtPlaces(addresses.get(0).getLocality(),addDate,addresses.get(0).getAddressLine(0),latLng.latitude,latLng.longitude)){
    ...
    public void btnClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_direction:
                ...
                Fetchingdirection getDirectionsData = new Fetchingdirection();
            ...
            case R.id.btn_addfavrt:
                Intent intent2 = new Intent(this,AddFileActivity.class);
